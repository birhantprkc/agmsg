...
[retention-gap recovery](../../docs/spec/retention-gap-resynchronization.md): it
...
[read-state synchronization specification](../../docs/spec/read-state-synchronization.md).
