...
encrypted profile is [`age-v1`](../../docs/spec/draft/age-v1-profile.md).
...
[retention-gap recovery](../../docs/spec/draft/retention-gap-resynchronization.md): it
...
[read-state synchronization specification](../../docs/spec/draft/read-state-synchronization.md).
